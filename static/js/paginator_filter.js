document.addEventListener("DOMContentLoaded", (e) => {
  ...
  function getCurrentPage() {
    ...
    if (window.location.search.match(/page-id=(\d+)/) != null) {
      currentIdx = Number(window.location.search.match(/page-id=(\d+)/)[1]) - 1;
    } else {
      currentIdx = 1;
    }
  ...
  function changePage(e) {
    ...
    const baseURL =
      window.location.href.replace(/\&page-id=[0-9]/, "") + "&page-id=";
